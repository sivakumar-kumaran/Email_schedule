    ...
    <main suppressHydrationWarning className="relative min-h-screen flex items-center justify-center p-4 sm:p-6 overflow-hidden bg-[#07090e]">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-tr from-brand-600 to-accent-violet text-white shadow-xl shadow-brand-600/30 mb-3 border border-white/10">
        ...
        <p className="text-center text-[11px] text-slate-500 mt-5">
          ReachInbox Scheduling Engine • Next.js 14 & Express Monorepo
        </p>
      </div>
    </main>
  );
